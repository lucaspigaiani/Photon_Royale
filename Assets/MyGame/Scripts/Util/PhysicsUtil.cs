...
public class PhysicsUtil 
{
    public static bool ThreeRaycasts(Vector3 origin, Vector3 dir, float spacing, Transform transform, out List<RaycastHit> hits, float distance, LayerMask layer, bool debugDraw = false)
    {
        ...
        bool leftHitFound = Physics.Raycast(origin - transform.right, Vector3.down, out RaycastHit leftHit, distance, layer);
        bool rightHitFound = Physics.Raycast(origin + transform.right, Vector3.down, out RaycastHit rightHit, distance, layer);
